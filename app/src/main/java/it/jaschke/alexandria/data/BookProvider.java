    ...
    static
    {
        ...
        bookFull.setTables(
                AlexandriaContract.BookEntry.TABLE_NAME + " LEFT OUTER JOIN " +
                        AlexandriaContract.AuthorEntry.TABLE_NAME + " USING (" +
        ...
        switch(uriMatcher.match(uri))
        {
            ...
            case BOOK_FULLDETAIL:
                String[] bfd_projection = {
                        AlexandriaContract.BookEntry.TABLE_NAME + "." + AlexandriaContract
                                .BookEntry.TITLE,
                        AlexandriaContract.BookEntry.TABLE_NAME + "." + AlexandriaContract
                                .BookEntry.SUBTITLE,
                        AlexandriaContract.BookEntry.TABLE_NAME + "." + AlexandriaContract
    ...
    public Uri insert(Uri uri, ContentValues values)
    {
        ...
        switch(match)
        {
            case BOOK:
            {
                ...
                getContext().getContentResolver().notifyChange(AlexandriaContract.BookEntry
                        .buildFullBookUri(_id), null);
                break;
            }
            case AUTHOR:
            {
                ...
                if(_id > 0)
                {
                    returnUri = AlexandriaContract.AuthorEntry.buildAuthorUri(values.getAsLong
                            ("_id"));
                }
                else
                {
            ...
            case CATEGORY:
            {
                ...
                if(_id > 0)
                {
                    returnUri = AlexandriaContract.CategoryEntry.buildCategoryUri(values
                            .getAsLong("_id"));
                }
                else
                {
