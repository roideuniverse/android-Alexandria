...
public class DbHelper extends SQLiteOpenHelper
{
    ...
    public void onCreate(SQLiteDatabase db)
    {
        ...
        final String SQL_CREATE_BOOK_TABLE = "CREATE TABLE " + AlexandriaContract.BookEntry
                .TABLE_NAME + " (" +
        ...
        final String SQL_CREATE_AUTHOR_TABLE = "CREATE TABLE " + AlexandriaContract.AuthorEntry
                .TABLE_NAME + " (" +
        ...
        final String SQL_CREATE_CATEGORY_TABLE = "CREATE TABLE " + AlexandriaContract
