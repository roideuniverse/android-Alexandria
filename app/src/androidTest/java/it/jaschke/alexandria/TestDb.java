...
public class TestDb extends AndroidTestCase
{
    ...
    public final static String imgUrl = "http://books.google" +
            ".com/books/content?id=KI2WQgAACAAJ&printsec=frontcover&img=1&zoom=1";
    public final static String desc = "Presents a guide to artificial intelligence, covering such" +
            " topics as intelligent agents, problem-solving, logical agents, planning, " +
            "uncertainty, learning, and robotics.";
