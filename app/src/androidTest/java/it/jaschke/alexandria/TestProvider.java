...
public class TestProvider extends AndroidTestCase
{
    ...
    public void testGetType()
    {
        ...
        String type = mContext.getContentResolver().getType(AlexandriaContract.BookEntry
                .CONTENT_URI);
        ...
        type = mContext.getContentResolver().getType(AlexandriaContract.BookEntry
                .buildFullBookUri(id));
        assertEquals(AlexandriaContract.BookEntry.CONTENT_ITEM_TYPE, type);

        type = mContext.getContentResolver().getType(AlexandriaContract.AuthorEntry
                .buildAuthorUri(id));
        assertEquals(AlexandriaContract.AuthorEntry.CONTENT_ITEM_TYPE, type);

        type = mContext.getContentResolver().getType(AlexandriaContract.CategoryEntry
                .buildCategoryUri(id));
    ...
    public void insertReadBook()
    {
        ...
        Uri bookUri = mContext.getContentResolver().insert(AlexandriaContract.BookEntry
                .CONTENT_URI, bookValues);
    ...
    public void insertReadAuthor()
    {
        ...
        Uri authorUri = mContext.getContentResolver().insert(AlexandriaContract.AuthorEntry
                .CONTENT_URI, authorValues);
    ...
    public void insertReadCategory()
    {
        ...
        Uri categoryUri = mContext.getContentResolver().insert(AlexandriaContract.CategoryEntry
                .CONTENT_URI, categoryValues);
